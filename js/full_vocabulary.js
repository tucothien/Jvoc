  ...
  },
  {
    ...
    "vocabulary": [
      ...
      },
      {
        "hiragana": "おくります",
        "kanji": "送ります「駅まで友達を」",
        "vietnamese": "đưa, tiễn (bạn đến ga)",
        "info": ""
      },
      {
        "hiragana": "しょうかいします",
        "kanji": "紹介します「友達を先生に」",
        "vietnamese": "giới thiệu (bạn với thầy)",
        "info": "紹 (thiệu) 召(triệu: hồi) 介(giới: cõi)"
      },
      {
        "hiragana": "あんないします",
        "kanji": "案内します「使い方を」",
        "vietnamese": "hướng dẫn, chỉ (cách dùng)",
        "info": "案 (án)"
      },
      {
        "hiragana": "せつめいします",
    ...
    "vocabulary": [
      {
        ...
        "kanji": "売れます",
        "vietnamese": "bán (chạy)",
        "info": "売 (mại) tự động từ | よく売れている"
      },
      {
        "hiragana": "おどります",
        "kanji": "踊る",
        "vietnamese": "nhảy",
        "info": "踊 (dũng: nhảy) | 止 (chỉ)"
      },
      {
        "hiragana": "かみます",
        "kanji": "噛む",
        "vietnamese": "nhai, cắn",
        "info": "噛 (giảo: cắn) | 歯 (xỉ)"
      },
      {
        "hiragana": "えらびます",
        "kanji": "選ぶ",
        "vietnamese": "lựa, lựa chọn",
        "info": "選 (tuyển) 己 (kỷ) | 共 (cộng)"
      },
      {
        "hiragana": "かよいます (がっこうに)",
        "kanji": "通う (学校に)",
        "vietnamese": "đi học (trường học)",
        "info": "通 (thông)"
      },
      {
        "hiragana": "メモします",
      ...
      },
      {
        "hiragana": "まじめ (な がくせい)",
        "kanji": "真面目 (な 学生)",
        "vietnamese": "nghiêm túc, cần cù (học sinh)",
        "info": "真 (chân) 面 (diện) | 目(mục)"
      },
      {
        "hiragana": "ねっしん (な)",
        "kanji": "熱心 (な)",
        "vietnamese": "nhiệt tình",
        "info": "熱 (nhiệt) 埶(nghệ: thuật) | 心 (tâm)"
      },
      {
        "hiragana": "えらい",
        "kanji": "偉い",
        "vietnamese": "vĩ đại, kính trọng",
        "info": "偉 (vĩ) 韋(vi) | 違(vi: khác)"
      },
      {
        "hiragana": "ちょうどいい (サイズは)",
        "kanji": "丁度いい (サイズは)",
        "vietnamese": "vừa đúng, vừa vặn (size)",
        "info": "丁 (đinh) 度 (độ)"
      },
      {
        "hiragana": "やさしい",
        "kanji": "優しい",
        "vietnamese": "hiền lành, tốt bụng",
        "info": "優 (ưu: tiên) 憂 (ưu: phiền) | 夏 (hạ)"
      },
      {
        "hiragana": "しゅうかん",
        "kanji": "習慣",
        "vietnamese": "tập quán",
        "info": "習 (tập) 慣 (quán: tính) | 貫 (quán: nhất) 忄(tâm)"
      },
      {
        "hiragana": "けいけん",
        "kanji": "経験",
        "vietnamese": "kinh nghiệm",
        "info": "経 (kinh) 圣 (thánh) | 験 (nghiệm)"
      },
      {
        "hiragana": "ちから",
        "kanji": "力",
      ...
      },
      {
        ...
        "kanji": "値段",
        "vietnamese": "giá cả",
        "info": "値 (trị) 直 (trực) | 段 (đoạn) 殳(thù) | nói thông dụng hơn 価格"
      },
      {
        "hiragana": "きゅうりょう",
        "kanji": "給料",
        "vietnamese": "lương",
        "info": "給 (cấp) 糸 (mịch) 合 (hợp) | 料 (liệu) 米 (mễ) 斗 (đấu)"
      },
      {
        "hiragana": "ばんぐみ",
        "kanji": "番組",
        "vietnamese": "chương trình(truyền hình,phát thanh,..)",
        "info": "番 (phiên: lượt) 釆 (biện: khác) | 組 (tổ: chức) 祖 (tổ: tiên)"
      },
      {
        "hiragana": "ドラマ",
        "kanji": "ドラマ",
      ...
      },
      {
        ...
        "kanji": "歌手",
        "vietnamese": "ca sĩ",
        "info": "歌 (ca) 欠 (khiếm) 可 (khả)"
      },
      {
        "hiragana": "かんりにん",
        "kanji": "管理人",
        "vietnamese": "người quản lí",
        "info": "管 (quản) 官 (quan) ⺮ (trúc) | 理 (lý)"
      },
      {
        "hiragana": "むすこ",
        "kanji": "息子",
        "vietnamese": "con trai",
        "info": "息 (tức: lợi, khí, con trai)"
      },
      {
        "hiragana": "むすめ",
        "kanji": "娘",
        "vietnamese": "con gái",
        "info": "娘 (nương) 女 (nữ) 良 (lương)"
      },
      {
        "hiragana": "しばらく",
        "kanji": "暫く",
        "vietnamese": "một khoảng thời gian ngắn, một chút, một lát",
        "info": "暫 (tạm) 斬 (trảm) 斤(cân)"
      },
      {
        "hiragana": "たいてい",
        "kanji": "たいてい",
      ...
      },
      {
        ...
        "info": "喋 (điệp: nói) 枼 (diệp: tấm ván mỏng)| 葉 (diệp: lá cây)"
      },
      {
        "hiragana": "おしらせ",
        "kanji": "お知らせ",
        "vietnamese": "thông báo",
        "info": "知 (tri) 矢 (thỉ: mũi tên)"
      },
      {
        "hiragana": "ひにち (りょこう の)",
        "kanji": "日にち (旅行の)",
        "vietnamese": "ngày (du lịch)",
        "info": ""
      },
      {
        "hiragana": "たいいくかｎ",
    ...
    "vocabulary": [
      {
        ...
        "kanji": "褒める",
        "vietnamese": "khen",
        "info": "tha, 褒 (bao) 保 (bảo: vệ)| 衣 (y) 亻 (nhân) 呆 (ngốc: dại)"
      },
      {
        "hiragana": "しかります",
        "kanji": "叱る",
        "vietnamese": "mắng",
        "info": "tha, 叱 (sất: quát)| 七 (thất) 口 (khẩu)"
      },
      {
        "hiragana": "さそいます",
        "kanji": "誘う",
        "vietnamese": "mời, rủ rê",
        "info": "tha, 誘 (dụ: rủ) 秀 (tú: tài)| 言 (ngôn) 乃 (nãi) 禾 (hòa)"
      },
      {
        "hiragana": "おこします",
        "kanji": "起こす",
        "vietnamese": "đánh thức",
        "info": "tha, 起 (khởi) 己 (kỉ) 走 (tẩu)"
      },
      {
        "hiragana": "しょうたいします",
        "kanji": "招待する",
        "vietnamese": "mời",
        "info": "招 (chiêu) 召 (triệu: tập) |扌 (thủ) 待 (đãi: chờ) 彳 (xích) 寺 (tự)"
      },
      {
        "hiragana": "たのみます",
        "kanji": "頼む",
        "vietnamese": "nhờ",
        "info": "tha, 頼 (lại: ỷ) 頁 (hiệt) 束 (thúc: bó)"
      },
      {
        "hiragana": "とります",
        "kanji": "盗る",
        "vietnamese": "ăn trộm , lấy cắp",
        "info": "tha, 盗 (đạo: chích) |次 (thứ) 皿 (mãnh)"
      },
      {
        "hiragana": "ふみます",
        "kanji": "踏む",
        "vietnamese": "giẫm , giẫm lên",
        "info": "tha, 踏 (đạp) ⻊ 沓 (đạp: chồng chất)| 水 (thủy) 日 (nhật)"
      },
      {
        "hiragana": "こわします",
        "kanji": "壊します",
        "vietnamese": "phá, làm hỏng",
        "info": "tha, 壊 (hoại) 十 (thập) 罒 (võng) |衣 (y) 土 (thổ), 壊れる (tự)"
      },
      {
        "hiragana": "よごします",
        "kanji": "汚す",
        "vietnamese": "làm bẩn",
        "info": "tha, 汚 (ô) 丂 (khảo) 一 (nhất) |氵 (thủy) 汚れる(tự)"
      },
      {
        "hiragana": "おこないます",
        "kanji": "行う",
        "vietnamese": "thực hiện, tiến hành",
        "info": "tha, 行 (hành) 彳 (xích) |一 (nhất) 丁 (đinh)"
      },
      {
        "hiragana": "ゆしゅつします",
        "kanji": "輸出する",
        "vietnamese": "xuất khẩu",
        "info": "輸 (thâu) 俞 (du) 車 (xa)"
      },
      {
        "hiragana": "ゆにゅうします",
        "kanji": "輸入する",
      ...
      },
      {
        ...
        "info": "翻 (phiên) 番 (phiên) 羽 (vũ) |釆 (biện) 田 (điền) |訳 (dịch) 尺 (xích) 言 (ngôn)"
      },
      {
        "hiragana": "はつめいします",
        "kanji": "発明する",
        "vietnamese": "phát minh",
        "info": "発 (phát) 癶 (bát) 二 (nhị)| 儿 (nhân) 明 (minh)"
      },
      {
        "hiragana": "はっけんします",
        "kanji": "発見する",
        "vietnamese": "phát kiến, tìm ra",
        "info": "発 (phát) 癶 (bát) 二 (nhị) |儿 (nhân) 見 (kiến)"
      },
      {
        "hiragana": "せっけいします",
        "kanji": "設計する",
        "vietnamese": "thiết kế",
        "info": "設 (thiết) 殳 (thù) 言 (ngôn)| 計 (kế, kê) 十 (thập)"
      },
      {
        "hiragana": "こめ",
        "kanji": "米",
      ...
      },
      {
        ...
        "kanji": "石油",
        "vietnamese": "dầu mỏ",
        "info": "石 (thạch) 油 (du: dầu)| 氵 (thủy) 由 (do: tự)"
      },
      {
        "hiragana": "げんりょう",
        "kanji": "原料",
        "vietnamese": "nguyên liệu",
        "info": "原 (nguyên) 厂 (hán) 小 (tiểu) |白 (bạch) 料 (liệu) 米 (mễ) 斗 (đấu)"
      },
      {
        "hiragana": "どろぼう",
        "kanji": "泥棒",
        "vietnamese": "kẻ trộm",
        "info": "泥 (nê: bùn) 尼 (ni: cô) 氵 (thủy) |棒 (bổng) 木 (mộc) 奉 (phụng: sự)"
      },
      {
        "hiragana": "けいかん",
        "kanji": "警官",
        "vietnamese": "cảnh sát",
        "info": "警 (cảnh) 敬 (kính) 言 (ngôn) 官 (quan)"
      },
      {
        "hiragana": "けんちくか",
        "kanji": "建築家",
        "vietnamese": "kiến trúc sư",
        "info": "建 (kiến, kiển) 廴 (dẫn) |聿 (duật) 築 (trúc) 凡 (phàm: phu) |工 (công) ⺮ () 木 (mộc) 家 (gia, cô)"
      },
      {
        "hiragana": "かがくしゃ",
        "kanji": "科学者",
        "vietnamese": "nhà khoa học",
        "info": "科 (khoa) 禾 (hòa) |斗 (đấu) 学 (học) 者 (giả)"
      },
      {
        "hiragana": "せかいじゅう",
        "kanji": "世界中",
      ...
      },
      {
        ...
        "kanji": "埋め立てる",
        "vietnamese": "lấp",
        "info": "tha, 埋 (mai) 里 (lí) |土 (thổ) 立 (lập) 理 (lí)"
      },
      {
        "hiragana": "ぎじゅつ",
        "kanji": "技術",
        "vietnamese": "kỷ thuật",
        "info": "技 (kĩ) 扌 (thủ) 支 (chi: nhánh)| 術 (thuật) 朮 (truật) 行 (hành)"
      },
      {
        "hiragana": "とち",
        "kanji": "土地",
        "vietnamese": "đất, diện tích đất",
        "info": "土 (thổ) 地 (địa) 也 (dã)"
      },
      {
        "hiragana": "そうおん",
        "kanji": "騒音",
        "vietnamese": "tiếng ồn",
        "info": "騒 (tao) 馬 (mã) 虫 (trùng) |又 (hựu) 音 (âm) さわぎます 騒ぐ làm ồn"
      },
      {
        "hiragana": "りようします",
        "kanji": "利用する",
        "vietnamese": "sử dụng",
        "info": "利 (lợi) 禾 (hòa) |刂 (đao) 用 (dụng)"
      },
      {
        "hiragana": "ごうか（な）",
        "kanji": "豪華（な）",
        "vietnamese": "hào hoa,sang trọng",
        "info": "豪 (hào) 高 (cao) 豕 (thỉ) |華 (hoa, hóa) 垂 (thùy: rủ xuống) |艹 (thảo)"
      },
      {
        "hiragana": "ちょうこく",
        "kanji": "彫刻",
        "vietnamese": "điêu khắc",
        "info": "彫 (điêu) 彡 (sam) 周 (chu) |刻 (khắc) 亥 (hợi: heo) |刂 (đao) 幺 (yêu) 亠 (đầu)"
      },
      {
        "hiragana": "ねむります",
        "kanji": "眠る",
        "vietnamese": "ngủ",
        "info": "眠 (miên) 目 (mục) 民 (dân)"
      },
      {
        "hiragana": "ほります",
        "kanji": "彫る",
        "vietnamese": "khắc, chạm",
        "info": "tha, 彫 (điêu) 彡 (sam) 周 (chu)"
      },
      {
        "hiragana": "なかま",
        "kanji": "仲間",
        "vietnamese": "bạn bè,đồng nghiệp",
        "info": "仲 (trọng: ở giữa) 亻 (nhân) |中 (trung) 間 (gian) |日 (nhật) 門 (môn)"
      },
      {
        "hiragana": "ねずみ",
        "kanji": "鼠 ねずみ",
        "vietnamese": "chuột",
        "info": "鼠 (thử) 臼 (cữu: cối) 雨 (vũ)"
      }
    ]
  },
  {
    ...
    "vocabulary": [
      ...
      },
      {
        ...
        "info": "退 (thối, thoái) 艮 (quẻ: cấn)| ⻌ (sước) 良 (lương)"
      },
      {
        "hiragana": "いれます",
        "kanji": "入れます",
      ...
      },
      {
        ...
        "kanji": "掛ける",
        "vietnamese": "khóa",
        "info": "tha, 掛 (quải: treo) |扌 (thủ) 卜 (bặc) 圭 (khuê)"
      },
      {
        "hiragana": "あかちゃん",
        "kanji": "赤ちゃん",
      ...
      },
      {
        ...
        "kanji": "海岸",
        "vietnamese": "bờ biển",
        "info": "N, 海 (hải) 氵 (thủy) |毎 (mỗi) 岸 (ngạn: bờ) |山 (san) 干 (kiền: khô) 厂 (hán)"
      },
      {
        "hiragana": "うそ",
        "kanji": "うそ",
      ...
      },
      {
        ...
        "info": "N, 書 (thư) 聿 (duật) |日 (nhật) 類 (loại)| 頁 (hiệt) 大 (đại) 米 (mễ)"
      },
      {
        "hiragana": "でんげん",
        "kanji": "電源",
        "vietnamese": "nguồn điện , công tắc điện",
        "info": "N, 電 (điện) 电 (điện) |⻗ (vũ) 源 (nguyên: nguồn nước) |氵 (thủy) 原 (nguyên)"
      },
      {
        "hiragana": "かいらん",
        "kanji": "回覧",
        "vietnamese": "Tập thông báo",
        "info": "N, 回 (hồi, hối) 覧 (lãm)| 臣 (thần) 一 (nhất) |𠂉 () 見 (kiến)"
      },
      {
        "hiragana": "きちんと",
        "kanji": "きちんと",
      ...
      },
      {
        "hiragana": "せいりします",
        "kanji": "整理する",
        "vietnamese": "sắp xếp, arangement",
        "info": "整 (chỉnh: đều, ngay ngắn)| 敕 (sắc: lệnh) 攵 (phộc) |束 (thúc: bó) 正 (chánh) |理 (lí) 里 (lí) 王 (vương)"
      },
      {
        "hiragana": "おします",
        "kanji": "押す",
        "vietnamese": "đóng (dấu) (nhấn)",
        "info": "tha, 押 (áp) 甲 (giáp) 扌 (thủ)"
      },
      {
        "hiragana": "ふたご",
        "kanji": "双子",
        "vietnamese": "cặp sinh đôi",
        "info": "N, 双 (song) 又 (hựu) 子 (tử, tí)"
      },
      {
        "hiragana": "しまい",
        "kanji": "姉妹",
        "vietnamese": "chị em",
        "info": "N, 姉 (tỉ) 女 (nữ) |市 (thị) 妹 (muội) 未 (vị)"
      },
      {
        "hiragana": "にます",
        "kanji": "似る",
        "vietnamese": "giống",
        "info": "tự (2), 似 (tự: tương)| 亻 (nhân) 以 (dĩ)"
      },
      {
        "hiragana": "せいかく",
        "kanji": "性格",
        "vietnamese": "tính cách",
        "info": "N, 性 (tính) 忄 (tâm) 生 (sanh) |格 (cách, các) 各 (các) 木 (mộc)"
      },
      {
        "hiragana": "おとなしい",
        "kanji": "大人しい",
      ...
      },
      {
        ...
        "info": "世 (thế) 話 (thoại) |舌 (thiệt: lưỡi) 言 (ngôn)"
      },
      {
        "hiragana": "けんかします",
        "kanji": "喧嘩する",
        "vietnamese": "cãi nhau",
        "info": "喧 (huyên) 口 (khẩu) 宣 (tuyên) |嘩 (hoa) 華 (hoa: trung) 口 (khẩu)"
      },
      {
        "hiragana": "ふしぎ（な）",
        "kanji": "不思議（な）",
        "vietnamese": "bí ẩn , kỳ thú, khó hiểu.",
        "info": "不 (bất, phầu, phủ, phi) |思 (tư, tứ, tai) 心 (tâm) 田 (điền)| 議 (nghị) 言 (ngôn) 義 (nghĩa)"
      }
    ]
  },
  {
    ...
    "vocabulary": [
      ...
      },
      {
        ...
        "kanji": "倒れる",
        "vietnamese": "đổ",
        "info": "tự, 倒 (đảo) 亻 (nhân)| 到 (đáo) 至 (chí) |側 (trắc: phía)"
      },
      {
        "hiragana": "やけます（パン/にくが～）",
        "kanji": "焼ける（パン/肉が～）",
        "vietnamese": "nướng",
        "info": "tự, 焼 (thiêu)| 尭 (nghiêu: thuấn) 火 (hỏa)"
      },
      {
        "hiragana": "とおります",
        "kanji": "通る",
        "vietnamese": "đi qua, pass through",
        "info": "tự, 通 (thông)| 甬 (dũng) ⻌ ()"
      },
      {
        "hiragana": "びっくりします",
        "kanji": "びっくりする",
    ...
    "vocabulary": [
      {
        ...
        "kanji": "数える",
        "vietnamese": "đếm",
        "info": "数 (số) 女 (nữ) 米 (mễ) 攵 (phộc)"
      },
      {
        "hiragana": "はかります",
        "kanji": "測ります/量ります/計る",
        "vietnamese": "đo, cân (dài, nặng, time/num)",
        "info": "測 (trắc) 則 (tắc: phép) 氵 (thủy) |量 (lượng, lương) 旦 (đán) 里 (lí) 計(kế)"
      },
      {
        "hiragana": "たしかめます",
        "kanji": "確かめる",
        "vietnamese": "xác nhận",
        "info": "確 (xác) 隹 (chuy) 石 (thạch)"
      },
      {
        "hiragana": "あいます",
        "kanji": "合う",
      ...
      },
      {
        ...
        "info": "出 (xuất) 発 (phát) 癶 (bát) 二 (nhị)"
      },
      {
        "hiragana": "とうちゃくします",
        "kanji": "到着する",
        "vietnamese": "đến , đến nơi",
        "info": "到 (đáo) 至 (chí) 刂 (đao) 着 (trước)| ノ () 𦍌 () 目 (mục)"
      },
      {
        "hiragana": "よいます",
        "kanji": "酔う",
        "vietnamese": "say",
        "info": "酔 (túy) 卆 (cửu thập) 酉 (dậu)"
      },
      {
        "hiragana": "きけん（な）",
        "kanji": "危険（な）",
        "vietnamese": "nguy hiểm",
        "info": "危 (nguy) 厄 (ách) 険 (hiểm)"
      },
      {
        "hiragana": "ひつよう（な）",
        "kanji": "必要（な）",
        "vietnamese": "cần thiết",
        "info": "必 (tất) 心 (tâm) 要 (yếu, yêu) 女 (nữ)"
      },
      {
        "hiragana": "ぼうねんかい",
        "kanji": "忘年会",
        "vietnamese": "tiệc tất niên",
        "info": "忘 (vong) 亡 (vong) 心 (tâm) "
      },
      {
        "hiragana": "しんねんかい",
        "kanji": "新年会",
      ...
      },
      {
        ...
        "info": "裏 (lí) 衣 (y) 里 (lí) 亠 (đầu) "
      },
      {
        "hiragana": "へんじ",
        "kanji": "返事",
        "vietnamese": "hồi âm , trả lời",
        "info": "返 (phản) 反 (phản) ⻌ () 事 (sự)"
      },
      {
        "hiragana": "もうしこみ",
        "kanji": "申し込み",
        "vietnamese": "N, đăng ký",
        "info": "申 (thân: khỉ) 込 (vu) 込む(đông đúc)"
      },
      {
        "hiragana": "きず",
        "kanji": "傷",
        "vietnamese": "viết thương, xước, sẹo",
        "info": "傷 (thương) 亻 (nhân) 昜 (dương) 𠂉 ()"
      },
      {
        "hiragana": "ズボン",
        "kanji": "ズボン",
      ...
      },
      {
        ...
        "info": "便 (tiện) 亻 (nhân) 更 (canh)"
      },
      {
        "hiragana": "―ごう",
        "kanji": "ー号",
        "vietnamese": "số–",
        "info": "号 (hào, hiệu) 丂 (khảo) |口 (khẩu)"
      },
      {
        "hiragana": "―こ",
        "kanji": "―こ",
      ...
      },
      {
        "hiragana": "せいせき",
        "kanji": "成績",
        "vietnamese": "N, kết quả, thành tích",
        "info": "成 (thành) 戈 (qua: mâu) 績 (tích)| 責 (trách: nhiệm) 糸 (mịch)"
      },
      {
        "hiragana": "ようす",
        "kanji": "様子",
        "vietnamese": "N, vẻ, tình hình",
        "info": "様 (dạng: sama) 𦍌 () 水 (thủy) |木 (mộc) 子 (tử, tí)"
      },
      {
        "hiragana": "じけん",
        "kanji": "事件",
        "vietnamese": "N, sự kiện, vụ án",
        "info": "事 (sự) 件 (kiện) 亻 (nhân) |牛 (ngưu)"
      },
      {
        "hiragana": "ばくだん",
        "kanji": "爆弾",
        "vietnamese": "bom",
        "info": "爆 (bạo, bạc, bộc) 暴 (bạo: lực) |⺢ (thủy) 共 (cộng) 日 (nhật) 火 (hỏa)| 弾 (đàn, đạn) 単 (đơn: giản) 弓 (cung)"
      },
      {
        "hiragana": "はなれます",
        "kanji": "離れる",
        "vietnamese": "xa cách, xa",
        "info": "tự, 離 (li) 隹 (chuy) 离 (li)"
      },
      {
        "hiragana": "ゆうに",
        "kanji": "ゆうに",
        "vietnamese": "adv, gấp, đột nhiên",
        "info": ""
      },
      {
        "hiragana": "うごかします",
        "kanji": "動かす",
        "vietnamese": "tha, khởi động, chạy",
        "info": "動 (động) 重 (trọng) 力 (lực)"
      },
      {
        "hiragana": "はんにん",
        "kanji": "犯人",
        "vietnamese": "thủ phạm",
        "info": "犯 (phạm: xâm) 犭 (khuyển) 㔾 (tiết)"
      },
      {
        "hiragana": "てにいれます",
        "kanji": "手に入れる",
        "vietnamese": "tha, có được, lấy được, đoạt được",
        "info": ""
      },
      {
        "hiragana": "うわさします",
        "kanji": "噂する",
        "vietnamese": "đồn đại",
        "info": "噂 (đồn) 尊 (tôn) 寸 (thốn) 酋 (tù: trưởng)| 八 (bát) 酉 (dậu) 口 (khẩu)"
      }
    ]
  },
  {
    ...
    "vocabulary": [
      ...
      },
      {
        ...
        "kanji": "取り替える",
        "vietnamese": "đổi, thay",
        "info": "取 (thủ) 耳 (nhĩ) 又 (hựu)| 替 (thế: thay) 夫 (phu) 日 (nhật)"
      },
      {
        "hiragana": "おいわい（をします）",
        "kanji": "お祝い",
        "vietnamese": "quà; quà mừng",
        "info": "祝 (chúc, chú) 兄 (huynh) 礻 (thị)"
      },
      {
        "hiragana": "おとしだま",
        "kanji": "お年玉",
      ...
      },
      {
        ...
        "info": "情 (tình) 忄 (tâm) 青 (thanh) |報 (báo: đáp lại) 幸 (hạnh) 𠬝 ()"
      },
      {
        "hiragana": "ぶんぽう",
        "kanji": "文法",
        "vietnamese": "ngữ pháp",
        "info": "文 (văn, vấn) 法 (pháp) 去 (khứ) |氵 (thủy)"
      },
      {
        "hiragana": "さる",
        "kanji": "猿",
        "vietnamese": "con khỉ",
        "info": "猿 (viên: vượn) 犭 (khuyển) 袁 (viên) |袁 (viên: họ) 𧘇 (y) 口 (khẩu) 土 (thổ)"
      },
      {
        "hiragana": "えさ",
        "kanji": "餌 えさ",
      ...
      },
      {
        "hiragana": "えほん",
        "kanji": "絵本",
        "vietnamese": "sách tranh",
        "info": "絵 (hội) 会 (hội) 糸 (mịch) |本 (bổn, bản) 一 (nhất) 木 (mộc)"
      },
      {
        "hiragana": "えはがき",
        "kanji": "絵はがき",
        "vietnamese": "bưu ảnh",
        "info": "絵 (hội) 会 (hội) 糸 (mịch)"
      },
      {
        "hiragana": "ハンカチ",
        "kanji": "ハンカチ",
      ...
      },
      {
        ...
        "kanji": "靴下",
        "vietnamese": "vớ",
        "info": "靴 (ngoa: giày) 化 (hóa) 中 (trung) |廿 (nhập) 下 (hạ, há)"
      },
      {
        "hiragana": "てぶくろ",
        "kanji": "手袋",
        "vietnamese": "găng tay",
        "info": "手 (thủ) 袋 (đại) 代 (đại) 衣 (y)"
      },
      {
        "hiragana": "ゆびわ",
        "kanji": "指輪",
        "vietnamese": "nhẫn",
        "info": "指 (chỉ: ngón tay) 扌 (thủ) |輪 (luân) 冊 (sách) 車 (xa)"
      },
      {
        "hiragana": "まご",
        "kanji": "孫",
        "vietnamese": "cháu",
        "info": "孫 (tôn: cháu) 糸(mịch)"
      },
      {
        "hiragana": "あずかります",
        "kanji": "預かる",
      ...
      },
      {
        ...
        "info": "昔 (tích) 日 (nhật) 龷 (nhập) |話 (thoại) 舌 (thiệt: lưỡi) 言 (ngôn)"
      },
      {
        "hiragana": "かめ",
        "kanji": "亀",
      ...
      },
      {
        ...
        "info": "城 (thành) 土 (thổ) 成 (thành) |成 (thành: tựu) 戈 (qua: mác) 勹 (bao)"
      },
      {
        "hiragana": "おひめさま",
        "kanji": "お姫様",
        "vietnamese": "công chúa",
        "info": "姫 (cơ) 女 (nữ) 臣 (thần: quần) |様 (dạng) 𦍌 () 水 (thủy) 木 (mộc)"
      },
      {
        "hiragana": "くらします",
        "kanji": "暮らす",
      ...
      },
      {
        ...
        "kanji": "陸",
        "vietnamese": "lục địa",
        "info": "陸 (lục: đồng bằng cao ráo) |⻖ () 坴 ()"
      },
      {
        "hiragana": "けむり",
        "kanji": "煙",
        "vietnamese": "khói",
        "info": "煙 (yên) 覀 () 土 (thổ) 火 (hỏa)"
      },
      {
        "hiragana": "まっしろ［な］",
        "kanji": "真っ白［な］",
        "vietnamese": "trắng xoá",
        "info": "真 (chân) 十 (thập) 目 (mục) |丌 (kì) 白 (bạch) ノ () 日 (nhật)"
      },
      {
        "hiragana": "なかみ",
        "kanji": "中身",
        "vietnamese": "nội dung; bên trong",
        "info": "中 (trung, trúng) 身 (thân, quyên)"
      }
    ]
  },
  {
